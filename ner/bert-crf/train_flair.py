...
output_folder = f"flert-{dataset_name}-crf-{hf_model.replace('/', '.' ) }"
...
tagger = SequenceTagger.load( output_folder + '/' + 'model_epoch_7.pt' )
...
with open('bert_crf_news_ner_predictions.json', 'w') as f:
    json.dump(data, f)
